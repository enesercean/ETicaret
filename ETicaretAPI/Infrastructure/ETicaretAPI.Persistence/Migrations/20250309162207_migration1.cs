    ...
    public partial class migration1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SupplierContactPeople", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SupplierContactPeople_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Address = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    OrderTrackingNumber = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_OrderTrackingNumber",
                table: "Orders",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SupplierContactPeople_UserId",
                table: "SupplierContactPeople",
                column: "UserId");
        }
